...
public class AprendizDao implements MeAprendiz { 
    ...
    public boolean actualizar(Aprendiz ap) {
        String sql="update aprendiz set Docu='"+usu.getDocu()"', Nombrea='"+usu.getNombrea()"', Apellidoa='"+usu.getApellidoa()"', Correoa='"+usu.getCorreoa()"', Numcontacto='"+usu.getNumcontacto()"' where id="+usu.getId();
